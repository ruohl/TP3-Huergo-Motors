namespace HuegoVentas
{
    partial class frmVentaNueva
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ddVehiculo.SelectedIndexChanged += new System.EventHandler(this.ddVehiculo_SelectedIndexChanged);
			// 
			// gvAccesorios
			// 
			...
			this.Load += new System.EventHandler(this.frmVentaNueva_Load_1);
